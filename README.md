...
> **University:** Tampere University | **Course:** Comp.Sec.100-02 | **Pages:** 1–33
...
|------|--------|
| Questions | 32 MCQ |
| Passing score | 22 / 32 correct |
| Time allowed | 55 minutes |
| Wrong answer | −1/3 point |
| Empty answer | 0 points (no penalty) |
...
|------|-------|-----------|
| **1** | First Concepts | 5 |
| **2** | Some Victims and Attackers | 6 |
| **3** | Not Only Breaking Ciphers | 5 |
| **4** | Not Only Viruses | 6 |
| **5** | Networked Robots and Men | 3 |
| **6** | Risk and Three A-Properties | 4 |
| **7** | Policies and Models Do Not Protect | 6 |
| **8** | Credentials | 4 |
| **9** | Special Basic Protections | 7 |
| **10** | Repair and Punishment | 4 |
| **11** | More Than GDPR | 4 |
| **12** | Anonymity | 3 |
| **13** | IPR | 3 |
| **14** | Social Media | 4 |
| **15** | Ethics | 3 |
| **16** | Security Issues on Personal Devices | 4 |
| **17** | Risk Management, Policy | 4 |
| **18** | Non-disclosure, but Public Keys | 3 |
| **19** | Password | 5 |
| **20** | Cookie | 3 |
| **21** | CAPTCHA | 2 |
| **22** | Crypto Procedures | 6 |
| **23** | Keys and Chunks or Streams | 4 |
| **24** | One-time Pad, DES, AES | 4 |
| **25** | Public Key | 4 |
| **26** | Hash | 6 |
| **27** | The Most Common Protocols | 4 |
| **28** | Nature and Devices | 2 |
| **29** | Filtering | 5 |
| **30** | Secure Connection | 5 |
| **31** | Mobile Authentication | 4 |
| **32** | Start Running Programs | 6 |
| **33** | A Spectrum of Storage Issues | 3 |

**Total: 141 questions across 33 pages**

---

## Table of Contents

- [Page 1: First Concepts](#page-1-first-concepts)
- [Page 2: Some Victims and Attackers](#page-2-some-victims-and-attackers)
- [Page 3: Not Only Breaking Ciphers](#page-3-not-only-breaking-ciphers)
- [Page 4: Not Only Viruses](#page-4-not-only-viruses)
- [Page 5: Networked Robots and Men](#page-5-networked-robots-and-men)
- [Page 6: Risk and Three A-Properties](#page-6-risk-and-three-a-properties)
- [Page 7: Policies and Models Do Not Protect](#page-7-policies-and-models-do-not-protect)
- [Page 8: Credentials](#page-8-credentials)
- [Page 9: Special Basic Protections](#page-9-special-basic-protections)
- [Page 10: Repair and Punishment](#page-10-repair-and-punishment)
- [Page 11: More Than GDPR](#page-11-more-than-gdpr)
- [Page 12: Anonymity](#page-12-anonymity)
- [Page 13: IPR](#page-13-ipr)
- [Page 14: Social Media](#page-14-social-media)
- [Page 15: Ethics](#page-15-ethics)
- [Page 16: Security Issues on Personal Devices](#page-16-security-issues-on-personal-devices)
- [Page 17: Risk Management, Policy](#page-17-risk-management-policy)
- [Page 18: Non-disclosure, but Public Keys](#page-18-non-disclosure-but-public-keys)
- [Page 19: Password](#page-19-password)
- [Page 20: Cookie](#page-20-cookie)
- [Page 21: CAPTCHA](#page-21-captcha)
- [Page 22: Crypto Procedures](#page-22-crypto-procedures)
- [Page 23: Keys and Chunks or Streams](#page-23-keys-and-chunks-or-streams)
- [Page 24: One-time Pad, DES, AES](#page-24-one-time-pad-des-aes)
- [Page 25: Public Key](#page-25-public-key)
- [Page 26: Hash](#page-26-hash)
- [Page 27: The Most Common Protocols](#page-27-the-most-common-protocols)
- [Page 28: Nature and Devices](#page-28-nature-and-devices)
- [Page 29: Filtering](#page-29-filtering)
- [Page 30: Secure Connection](#page-30-secure-connection)
- [Page 31: Mobile Authentication](#page-31-mobile-authentication)
- [Page 32: Start Running Programs](#page-32-start-running-programs)
- [Page 33: A Spectrum of Storage Issues](#page-33-a-spectrum-of-storage-issues)

---

## Page 1: First Concepts

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | What is required of an attack to be regarded as a cyber atta... | **1. The target relies on an electronic infor...** |
| Q2 | Denial of service is a term | **3. that refers to a service not being able ...** |
| Q3 | What makes a denial of service attack (DoS) a distributed Do... | **4. The attacking traffic comes to the serve...** |
| Q4 | The term attack vector | **3. refers to the method of an attack - one ...** |
| Q5 | Confidentiality is one of the three basic goals ("C-I-A") of... | **3. but it is usually not sufficient without...** |

### Q1: What is required of an attack to be regarded as a cyber attack?

- [x] **1. The target relies on an electronic information system.** ✅
...
- [x] **3. that refers to a service not being able to operate because of malicious requests.** ✅
...
- [x] **4. The attacking traffic comes to the server from several computers simultaneously.** ✅
...
- [x] **3. refers to the method of an attack - one that happened or is possible.** ✅
...
- [x] **3. but it is usually not sufficient without integrity and availability.** ✅
...
## Page 2: Some Victims and Attackers

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | The term script kiddie is used for certain types of attacker... | **1. Essentially similar scripts to several o...** |
| Q2 | Attackers that are called script kiddies are characterized b... | **1. using scripts written by others.** |
| Q3 | Identity theft | **1. happens when someone maliciously uses id...** |
| Q4 | There are many digitals entities that spread mainly by the f... | **1. 4** |
| Q5 | All of the following attacks have some social aspect, but wh... | **4. Exercising the art of influencing people...** |
| Q6 | Successful impersonation means that | **4. somebody/something has been cheated to a...** |

### Q1: The term script kiddie is used for certain types of attackers. What is typical of them from a defender's perspective?

- [x] **1. Essentially similar scripts to several other attackers.** ✅
...
- [x] **1. using scripts written by others.** ✅
...
- [x] **1. happens when someone maliciously uses identifying data of another person.** ✅
...
> **Explanation:** Identity theft is the malicious use of someone else's identifying data. Requires malicious intent.
...
- [x] **4. Exercising the art of influencing people to act against their security policy.** ✅

> **Explanation:** Social engineering is the broad concept of manipulating people psychologically. Options 1 (phishing), 2 (dumpster diving) and 3 (shoulder surfing) are specific techniques.
...
- [x] **4. somebody/something has been cheated to act as if he/it is in contact with someone else than the attacker.** ✅
...
## Page 3: Not Only Breaking Ciphers

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | An attacker, who is not a legitimate party of a conversation... | **4. eavesdropper.** |
| Q2 | What is a description of a dictionary attack? | **2. It is a "sophisticated" brute-force atta...** |
| Q3 | Backdoor | **4. is an intentionally made or maliciously ...** |
| Q4 | Ransomware is | **2. a program that makes your data inaccessi...** |
| Q5 | How can an attack be passive? | **3. A passive attack is such that does not i...** |
...
- [x] **2. It is a "sophisticated" brute-force attack against passwords, taking into account that they were invented by users of natural languages.** ✅
...
> **Explanation:** A dictionary attack tries common words and phrases instead of random combinations. Option 3 describes rainbow tables.
...
- [x] **4. is an intentionally made or maliciously installed method of bypassing normal authentication or encryption in an information system.** ✅
...
- [x] **2. a program that makes your data inaccessible to you and asks for money to restore access.** ✅
...
- [x] **3. A passive attack is such that does not interfere with the integrity or availability of the victim's computing.** ✅
...
## Page 4: Not Only Viruses

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | Malware that does not replicate, pretends to be performing a... | **4. a Trojan horse.** |
| Q2 | What is a common feature of all malicious programs? | **1. They are capable of similar actions as o...** |
| Q3 | A macro virus is malware that | **4. runs on many different platforms (OS's) ...** |
| Q4 | There are many terms that mean some sort of showing or comin... | **3. exposure.** |
| Q5 | What is the term used for an attack or error that causes dat... | **3. Buffer overflow** |
| Q6 | The term zero-day applies for instance to | **3. a vulnerability in software not yet expl...** |
...
> **Explanation:** A Trojan horse disguises itself as legitimate software. Key: does NOT replicate unlike virus or worm.

### Q2: What is a common feature of all malicious programs?

- [x] **1. They are capable of similar actions as other programs in their running environment.** ✅
...
- [x] **4. runs on many different platforms (OS's) because it is interpreted by its host program.** ✅

> **Explanation:** Macro viruses run inside host programs like Word or Excel. Cross-platform ability is the key characteristic.
...
## Page 5: Networked Robots and Men

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | Which of the following fits most poorly to the concept of a ... | **1. Users of machines on the bot network hav...** |
| Q2 | Man in the middle is an attack type where | **2. the attacker or his process relays modif...** |
| Q3 | A botnet is | **2. a group of dispersed, compromised machin...** |

### Q1: Which of the following fits most poorly to the concept of a bot network?

- [x] **1. Users of machines on the bot network have agreed to work with the network administrator.** ✅
...
> **Explanation:** A botnet is built from compromised machines whose owners do NOT know. Agreed participation would make it a legitimate distributed network.
...
- [x] **2. the attacker or his process relays modified messages between two unknowing communication parties.** ✅
...
> **Explanation:** In MITM the attacker positions between two parties, intercepts and can modify messages. Option 1 describes a rootkit.

### Q3: A botnet is

- [ ] 1. a network used solely for internal communications.
- [x] **2. a group of dispersed, compromised machines controlled remotely for illicit purposes.** ✅
...
> **Explanation:** A botnet is compromised computers controlled by an attacker without owners' knowledge.

---

## Page 6: Risk and Three A-Properties

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | Information assurance is sometimes considered a wider term t... | **3. evidence that security mechanisms are ef...** |
| Q2 | Authentication is the | **4. process of verifying an identity.** |
| Q3 | The objective of Availability is to make information accessi... | **4. 3** |
| Q4 | Which of the following couplings best defines risk? | **1. Threat & vulnerability** |
...
- [x] **3. evidence that security mechanisms are efficient.** ✅
- [ ] 4. the level up to which risk management has been able to transfer information security risks.

> **Explanation:** Assurance is the confidence or evidence that security measures actually work. Not a synonym for authentication or accountability.
...
- [x] **4. process of verifying an identity.** ✅
...
## Page 7: Policies and Models Do Not Protect

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | Access control means | **3. measures, usually automatic, taken to de...** |
| Q2 | The security goal Accountability lies outside the ordinary C... | **1. I** |
| Q3 | Assume "S." stands for "Security", and count how many of the... | **4. 5** |
| Q4 | The strategy of forming layers of protection around an asset... | **2. defence-in-depth.** |
| Q5 | Non-repudiation as a security objective means that | **4. the person to whom the information relat...** |
| Q6 | Non-repudiation is | **1. a special security goal.** |
...
- [x] **3. measures, usually automatic, taken to decide whether access to a resource must be granted or denied, based on a policy.** ✅
- [ ] 4. the entirety of identification, authentication, access decision and then either blocking or enabling access.

> **Explanation:** Access control is the enforcement mechanism. Option 2 describes policy. Option 4 is too broad.
...
> **Explanation:** Accountability requires authenticity combined with integrity (I) of audit records. Without integrity of logs, accountability is meaningless.
...
- [ ] 1. cascade zoning.
- [x] **2. defence-in-depth.** ✅
- [ ] 3. secured perimeter.
- [ ] 4. onion thresholding.

> **Explanation:** Defence-in-depth uses multiple layers of security so if one fails others still protect.
...
- [x] **4. the person to whom the information relates has no grounds for claiming that there is no connection.** ✅

> **Explanation:** Non-repudiation means a party cannot deny having sent or received a message. Denial is impossible.

### Q6: Non-repudiation is

- [x] **1. a special security goal.** ✅
...
> **Explanation:** Non-repudiation is a security goal ensuring parties cannot deny their actions. Sits alongside the CIA triad.
...
| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | Which counts as two factor authentication? | **4. A PIN and a hard token.** |
| Q2 | What is the term used for such collections of data that a pe... | **4. credentials** |
| Q3 | Decisions on who can access certain data, like documents or ... | **1. data owner.** |
| Q4 | Shared secret is an InfoSec term that usually refers to | **1. a result of protocols like IKE (Internet...** |
...
> **Explanation:** Credentials are the data used to prove identity. Attributes are characteristics. Certificates are a specific type.
...
> **Explanation:** The data owner knows the sensitivity and value of their data best. Principle behind discretionary access control.

### Q4: Shared secret is an InfoSec term that usually refers to

- [x] **1. a result of protocols like IKE (Internet Key Exchange) of IPsec.** ✅
...
## Page 9: Special Basic Protections

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | One of the tasks of a certification authority is | **4. to publish a list of revoked certificate...** |
| Q2 | Challenge-response is a protocol between two parties A and B... | **4. A challenges B to respond with something...** |
| Q3 | A digital signature is made with | **4. a hash function and an asymmetric crypto...** |
| Q4 | At what phase of a product's life cycle is it likely to be m... | **1. implementation** |
| Q5 | What does a firewall prevent from functioning in the way the... | **4. packets** |
| Q6 | What security concept is violated by the following: One pers... | **3. Separation of duties** |
| Q7 | Steganography is | **2. an art of embedding data into a larger q...** |
...
- [x] **4. to publish a list of revoked certificates or provide a service that returns the certificate status.** ✅
...
- [x] **4. A challenges B to respond with something that no one else than A - and possibly B itself - would be able to produce.** ✅

> **Explanation:** Challenge-response sends an unpredictable challenge only the legitimate party can answer. Option 1 is proof-of-work. Option 2 is CAPTCHA.
...
- [x] **4. a hash function and an asymmetric cryptoalgorithm.** ✅

> **Explanation:** A digital signature hashes the message then encrypts with private key. Recipient decrypts with public key and compares hashes.
...
> **Explanation:** The later in the development lifecycle you find and fix security problems the more expensive it is. Implementation is the latest stage among these options.
...
> **Explanation:** A firewall inspects and filters network packets. Ports, IP addresses and protocols are rule attributes but packets are what actually get blocked.
...
- [x] **2. an art of embedding data into a larger quantity of other data.** ✅
- [ ] 3. an obsolete method of protecting secret messages.
- [ ] 4. synonymous to digital watermarking.

> **Explanation:** Steganography hides a secret message within ordinary-looking data. Still actively used. Digital watermarking is a related but different concept.

---

## Page 10: Repair and Punishment

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | Which of the following statements is true? | **2. Removable flash memories are suitable as...** |
| Q2 | It is important to have an off-site backup copy of files to | **4. prevent the loss of data in the event of...** |
| Q3 | All of the following may be needed to repair broken integrit... | **4. redundancy** |
| Q4 | If you are a EU citizen and your personal data has been undu... | **3. the responsible company may have to pay ...** |

### Q1: Which of the following statements is true?

- [ ] 1. Printing on paper is not a serious method to back up data.
- [x] **2. Removable flash memories are suitable as backup media.** ✅
...
- [x] **4. prevent the loss of data in the event of a fire.** ✅
...
- [x] **3. the responsible company may have to pay a fine of millions of euros.** ✅
- [ ] 4. nobody will be held responsible if the data has been leaked through hacking and the attacker is not caught.

> **Explanation:** Under GDPR, fines up to 20 million euros or 4% of global annual turnover. Company can be held responsible even if attacker is not caught.

---

## Page 11: More Than GDPR

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | The central meaning of data protection is in protecting | **2. the information that individuals disclos...** |
| Q2 | GDPR defines several roles with respect to a person's person... | **2. object.** |
| Q3 | The European Union has enacted General Data Protection Regul... | **2. the duties of organizations when they ha...** |
| Q4 | Payment card industry data security standard, PCI-DSS | **3. is, as its name says, a standard created...** |

### Q1: The central meaning of data protection is in protecting

- [ ] 1. the secret information of individuals.
- [x] **2. the information that individuals disclose to different data collectors.** ✅
...
- [x] **2. the duties of organizations when they handle data from individuals.** ✅
...
- [x] **3. is, as its name says, a standard created by an industry branch.** ✅
- [ ] 4. is not related to GDPR by purpose or origin.

> **Explanation:** PCI-DSS was created by major card brands (Visa, Mastercard etc.) not by a government. Industry standard not a law.
...
| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | When studying anonymity as a security goal it is natural to ... | **3. what data should not be disclosed and to...** |
| Q2 | Privacy is synonymous to | **3. none of these.** |
| Q3 | Pseudonym is | **4. an artificial name that replaces the rea...** |
...
- [x] **4. an artificial name that replaces the real name of a user.** ✅
...
| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | Copyright is originally a property of | **2. the creators of an artefact.** |
| Q2 | One purpose of DRM is | **1. to provide access control to digital med...** |
| Q3 | What is not a way to protect intellectual property? | **1. privacy regulations** |

### Q1: Copyright is originally a property of

- [ ] 1. an artefact.
- [x] **2. the creators of an artefact.** ✅
...
- [x] **1. to provide access control to digital media for protection of copyrights.** ✅
...
> **Explanation:** DRM controls how digital content can be accessed and distributed. Option 2 describes anti-circumvention laws.

### Q3: What is not a way to protect intellectual property?

- [x] **1. privacy regulations** ✅
...
| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | When you craft a job application you can include links to yo... | **2. The recruiter follows what is linked to ...** |
| Q2 | Social media is in constant motion and update is a buzzword ... | **1. Rectifying of fake news or "alternative ...** |
| Q3 | Social media is a "lively place" and update is a buzzword th... | **1. Links to sites that have published new p...** |
| Q4 | Who is responsible if you share in social media something th... | **2. You, without conditions.** |
...
- [x] **2. The recruiter follows what is linked to those postings, and finds something unfavourable of you.** ✅
...
- [x] **1. Rectifying of fake news or "alternative truths".** ✅
...
> **Explanation:** Social media spreads content quickly but is very slow to correct misinformation after it spreads.

### Q3: Social media is a "lively place" and update is a buzzword there. What kind of update, however, is usually poorly handled?

- [x] **1. Links to sites that have published new pages that correct earlier mistakes in their news.** ✅
- [ ] 2. Changes in a user's profile or credentials.
- [ ] 3. Algorithms and software of the platform.
- [ ] 4. Memberships in groups.

> **Explanation:** Corrections to previously shared false information are almost never propagated.
...
| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | Ethics is an important topic in information systems, | **1. and some aspects of it extending to the ...** |
| Q2 | What is not a topic of ethical considerations? | **3. Wasting your own and others' time by wri...** |
| Q3 | If you need to browse the internet anonymously, | **2. the TOR network is an option you can ser...** |

### Q1: Ethics is an important topic in information systems,

- [x] **1. and some aspects of it extending to the area of information security include treatment of privacy and IPR.** ✅
...
- [x] **3. Wasting your own and others' time by writing in social media long explanations of questionable quality.** ✅
- [ ] 4. Working out ways to block advertisements on web sites that get their income from displaying those ads.

> **Explanation:** This is a matter of quality and courtesy but not a genuine ethical dilemma. Options 1, 2 and 4 all involve real ethical questions.
...
- [x] **2. the TOR network is an option you can seriously consider.** ✅
...
## Page 16: Security Issues on Personal Devices

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | Assume you have logged in to a web site with your registered... | **4. The site uses a login cookie that persis...** |
| Q2 | Assume you buy a USB memory stick that has internal 256-bit ... | **1. 10^10** |
| Q3 | If your personal computer has a firewall, it is typically | **2. one process among others.** |
| Q4 | There is a vast variety of things that can be connected to t... | **3. Charging the new camping shower you just...** |
...
- [x] **4. The site uses a login cookie that persists even if the browser is not running.** ✅

> **Explanation:** A persistent login cookie is stored on your computer and sent automatically when you revisit. Browsers do not send passwords automatically.
...
- [x] **2. one process among others.** ✅
- [ ] 3. hardware on the network card.
- [ ] 4. an add-on to the browser process.

> **Explanation:** On a personal computer a firewall is a software process. Not hardware. Not tied to the browser.
...
- [x] **3. Charging the new camping shower you just bought from a Chinese web shop. (This is a little pump with a hose.)** ✅
- [ ] 4. The optical mouse that your IT staff checked for you to bring home from your office for remote work.

> **Explanation:** A simple water pump only needs power and has no data capability. Option 1 has document malware risk. Option 2 risks juice jacking.

---

## Page 17: Risk Management, Policy

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | What control mechanisms can be left out of the risk analysis... | **3. Mechanisms that do not control threats t...** |
| Q2 | Which of the following does not need to be considered in the... | **1. How much is invested in information secu...** |
| Q3 | Compared to a previous estimate, the overall risk is reduced... | **4. the value of an asset is found to be sma...** |
| Q4 | Alice has been tasked with implementing several security con... | **1. risk mitigation.** |
...
- [x] **3. Mechanisms that do not control threats to the system under consideration.** ✅
- [ ] 4. Those that solve the same problem as the mechanisms already addressed in the analysis.

> **Explanation:** Risk analysis should only include controls relevant to the threats being analyzed.

### Q2: Which of the following does not need to be considered in the risk analysis?

- [x] **1. How much is invested in information security in competing companies.** ✅
...
- [x] **4. the value of an asset is found to be smaller than before.** ✅

> **Explanation:** Risk = Threat x Vulnerability x Asset Value. If an asset is genuinely worth less the real risk is lower.
...
> **Explanation:** Risk mitigation means taking active steps to reduce risk by implementing controls.

---

## Page 18: Non-disclosure, but Public Keys

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | A non-disclosure agreement may have many forms, but its usua... | **2. to prevent an employee or visitor from r...** |
| Q2 | The basic goal of a public key infrastructure is to | **2. bind the public key to the entity to whi...** |
| Q3 | Assume K is a public key and S is the corresponding private ... | **1. someone else uses his private key for a ...** |
...
- [x] **2. to prevent an employee or visitor from revealing sensitive information of an organization.** ✅
...
> **Explanation:** An NDA binds a person to keep organizational information confidential. Option 1 describes GDPR. Option 3 describes a classification policy.

### Q2: The basic goal of a public key infrastructure is to

- [ ] 1. bind a private key to a corresponding public key.
- [x] **2. bind the public key to the entity to which the key belongs.** ✅
...
> **Explanation:** PKI's fundamental purpose is to create a trusted link between a public key and the identity of its owner.
...
- [x] **1. someone else uses his private key for a signature that binds K and the identity of B.** ✅
...
> **Explanation:** A certificate is created when a CA uses its OWN private key to sign a binding between public key K and the identity of B.
...
| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | If you need to come up with a question and answer in a web s... | **2. the entropy of the answer** |
| Q2 | If your browser offers you the option to save for future use... | **3. The passwords in your browser are protec...** |
| Q3 | The instructions concerning the use of a password can be con... | **1. (ii) & (iii)** |
| Q4 | Which of the following is generally the most dangerous with ... | **1. uses the same password in several places...** |
| Q5 | It has been said of the password that it should be treated l... | **2. two** |
...
- [x] **3. The passwords in your browser are protected from others.** ✅
...
> **Explanation:** You must NEVER tell your password (ii). But you CAN save it (iii) in a trusted password manager.

### Q4: Which of the following is generally the most dangerous with passwords? The user

- [x] **1. uses the same password in several places.** ✅
...
> **Explanation:** A toothbrush represents: (iii) personal use only and (iv) change it often enough. Does NOT represent entropy or usability. Exactly two features.
...
| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | With the exception of the cookie itself or other cookies, a ... | **3. either the integrity or confidentiality ...** |
| Q2 | In the original and still most common usage, the web browsin... | **4. web server, which gets it back from the ...** |
| Q3 | The purpose of a web browsing cookie is to transmit to the w... | **1. that is the same as the server has earli...** |
...
- [x] **3. either the integrity or confidentiality of your files.** ✅
- [ ] 4. the confidentiality of your files, but it may break their integrity.

> **Explanation:** A cookie cannot directly access or modify files on your computer.
...
- [x] **4. web server, which gets it back from the browser without changes.** ✅
...
- [x] **1. that is the same as the server has earlier transmitted to the browser.** ✅
...
| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | CAPTCHA or "Completely Automated Public Turing test to tell ... | **2. is an example of authentication that doe...** |
| Q2 | Why would you bother to write your email address in the form... | **1. To avoid spammers harvesting your real a...** |
...
- [x] **2. is an example of authentication that does not involve identification.** ✅
...
- [x] **1. To avoid spammers harvesting your real address so easily.** ✅
...
> **Explanation:** This is email address obfuscation. Adding POISTA MINUT breaks the email pattern so bots cannot harvest it.

---

## Page 22: Crypto Procedures

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | Cryptographic primitives are mainly | **3. procedures that a cryptology practitione...** |
| Q2 | Which of the following is mainly a task that can be performe... | **4. Agreeing on an encryption key.** |
| Q3 | Investigate the argument: Crypto algorithms are either symme... | **1. false because the list lacks algorithms ...** |
| Q4 | Which of the following is not covered by the concept of a cr... | **2. challenge-response method** |
| Q5 | An implementation of ____ that contains all the necessary so... | **2. cryptography, a cryptosystem** |
| Q6 | The term plaintext | **4. is a synonym for cleartext and the conce...** |
...
- [x] **3. procedures that a cryptology practitioner can view like indivisible blocks.** ✅
- [ ] 4. base numbers that generate all other numbers in modular arithmetic.

> **Explanation:** Primitives are the basic building blocks of cryptographic systems treated as indivisible black boxes.
...
- [x] **4. Agreeing on an encryption key.** ✅

> **Explanation:** A cryptographic protocol involves multiple parties exchanging messages. Key agreement (Diffie-Hellman) requires communication between parties.
...
- [x] **1. false because the list lacks algorithms that do not use a key.** ✅
...
- [x] **2. cryptography, a cryptosystem** ✅
- [ ] 3. cryptanalysis, cryptology
- [ ] 4. cryptology, cryptanalysis

> **Explanation:** Cryptography is the practice/science. A cryptosystem is a complete implementation.
...
## Page 23: Keys and Chunks or Streams

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | There are two classes of symmetric cryptographic methods, th... | **2. block, stream** |
| Q2 | Encryption is a method for protecting confidentiality of dat... | **4. can even be computed from a human-memora...** |
| Q3 | As a result of doubling the length of a symmetric encryption... | **4. T2.** |
| Q4 | Stream ciphers are one of the two classes of symmetric crypt... | **4. block algorithms.** |
...
> **Explanation:** If original key is n bits, brute force tries 2^n = T. Doubling to 2n bits means 2^(2n) = T squared. Doubling key LENGTH squares the brute force effort.
...
- [x] **4. block algorithms.** ✅

> **Explanation:** The two classes of symmetric cryptographic methods are stream ciphers and block ciphers.

---

## Page 24: One-time Pad, DES, AES

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | The most popular symmetric cryptosystem currently is | **1. AES.** |
| Q2 | DES, the Digital Encryption Standard, was for a long time th... | **3. produce confidentiality of communication...** |
| Q3 | What is a one-time pad? | **2. A single-use key together with the metho...** |
| Q4 | AES is a | **2. block cipher.** |
...
- [x] **3. produce confidentiality of communications.** ✅
...
- [x] **2. A single-use key together with the method of using it to encrypt and decrypt a message.** ✅
...
> **Explanation:** AES is a symmetric block cipher processing data in 128-bit blocks using keys of 128, 192 or 256 bits.
...
| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | A public key for ______ is a cryptographic analogue of a phy... | **1. encryption** |
| Q2 | A public key for ______ is a cryptographic analogue of a phy... | **3. verifying signatures** |
| Q3 | Which of the following does not apply? | **1. If the RSA decryption exponent is d, the...** |
| Q4 | Which of the following does not apply? | **3. An RSA signature cannot be made unless y...** |
...
> **Explanation:** Anyone can use the public key to lock (encrypt) data, but only the private key holder can unlock (decrypt) it.
...
- [x] **3. verifying signatures** ✅
- [ ] 4. signing messages

> **Explanation:** In digital signatures anyone can verify using the public key what the sender locked with their private key.

### Q3: Which of the following does not apply?

- [x] **1. If the RSA decryption exponent is d, then the RSA decryption program has to do d-1 modular multiplications.** ✅
...
| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | Which of the following is typical of checksums intended to p... | **2. They are calculated from all the charact...** |
| Q2 | The cryptographic hash value calculated from a message repre... | **2. it is very unlikely to find any other me...** |
| Q3 | How does a cryptographic hash value protect a message? | **3. The message cannot be changed without br...** |
| Q4 | Which of the following does not apply to keyed cryptographic... | **2. They are also called Cyclic Redundancy C...** |
| Q5 | Assume H is a good cryptographic hash function. How many bit... | **4. 260** |
| Q6 | Assume H is a good cryptographic hash function. How many bit... | **1. most likely none** |
...
- [x] **2. They are calculated from all the characters.** ✅
...
- [x] **2. it is very unlikely to find any other message with the same hash.** ✅
...
- [x] **3. The message cannot be changed without breaking the correspondence with the value.** ✅
...
- [x] **2. They are also called Cyclic Redundancy Checks.** ✅
...
> **Explanation:** There are 2^100 possible 100-bit strings. Probability = 1/2^40. Expected count = 2^100 / 2^40 = 2^60 (written as 260).
...
- [x] **1. most likely none** ✅
- [ ] 2. 225
- [ ] 3. 240
- [ ] 4. 260

> **Explanation:** Only 2^40 possible 40-bit strings. Probability = 1/2^100. Expected count is essentially zero. Input space is far too small.

---

## Page 27: The Most Common Protocols

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | IPsec | **1. provides mechanisms for authentication a...** |
| Q2 | What does key exchange mean in the sentence: "Key exchange i... | **4. A symmetric key is agreed upon.** |
| Q3 | The protocol and program of choice for setting up a window f... | **2. SSH.** |
| Q4 | TLS is a very common cryptographic protocol. The T in its na... | **3. transport.** |

### Q1: IPsec

- [x] **1. provides mechanisms for authentication and encryption.** ✅
- [ ] 2. only authenticates clients toward a server.
- [ ] 3. can only be deployed with IPv6.
- [ ] 4. provides mechanisms for nonrepudiation.

> **Explanation:** IPsec provides both authentication and encryption at the IP layer. Works with both IPv4 and IPv6.
...
- [x] **4. A symmetric key is agreed upon.** ✅
...
> **Explanation:** SSH (Secure Shell) is the standard protocol for securely connecting to a remote computer's command line.
...
## Page 28: Nature and Devices

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | What is true about fires? | **3. It is not so much the computers that cat...** |
| Q2 | The digital cash bits on a smart card cannot be extracted fr... | **4. The card's processor only transacts with...** |
...
- [x] **3. It is not so much the computers that catch fire, but the batteries and their charging are causing risks especially in mobile devices.** ✅
...
| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | A demilitarized zone, DMZ, means a part of an organization's... | **1. resides between two filtering devices.** |
| Q2 | Which of the following should mainly be able to filter packe... | **3. router** |
| Q3 | Which of the following can a packet filter do: (i) anti-viru... | **1. none of these** |
| Q4 | How does a packet filter react to TCP and UDP port numbers? | **2. It rejects the packet if either number i...** |
| Q5 | The tasks of a packet filter may include | **4. writing logs.** |

### Q1: A demilitarized zone, DMZ, means a part of an organization's network that

- [x] **1. resides between two filtering devices.** ✅
...
> **Explanation:** Routers operate at Layer 3 and can perform packet filtering based on IP addresses and port numbers.
...
> **Explanation:** A packet filter inspects only packet headers. It cannot inspect content for viruses, read attachments, or encrypt/decrypt traffic.

### Q4: How does a packet filter react to TCP and UDP port numbers?

- [ ] 1. It doesn't take them into account.
- [x] **2. It rejects the packet if either number is invalid.** ✅
...
## Page 30: Secure Connection

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | One possible action of IPsec is to add to each data packet a... | **4. a hash calculated from the packet and a ...** |
| Q2 | IPsec encrypts data packets on a protocol layer that is | **3. lower than in TLS.** |
| Q3 | If a remote user's machine fails to authenticate the target ... | **1. give the user's authentication informati...** |
| Q4 | Because TLS works below the application layer, it | **1. does not know what kind of data it prote...** |
| Q5 | Which of the following is more important in a VPN that must ... | **2. encryption** |
...
- [x] **3. lower than in TLS.** ✅
- [ ] 4. higher than in TLS.

> **Explanation:** IPsec operates at Layer 3 (Network layer). TLS operates between Layer 4 and Application layer. Layer 3 is lower.
...
- [x] **1. give the user's authentication information to an attacker.** ✅
...
- [x] **1. does not know what kind of data it protects.** ✅
...
## Page 31: Mobile Authentication

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | In the cell phone system the network authenticates the phone... | **2. Challenge-response method, with a symmet...** |
| Q2 | The mobile phone systems 2G, 3G, 4G, ... authenticate the su... | **4. by applying a cryptographic hash functio...** |
| Q3 | What is the relation between WiFi, WLAN, VLAN and WPA? | **1. WPA is the protection method for a WLAN,...** |
| Q4 | WPA is a cryptographic protocol for protecting wireless comm... | **2. (iv)** |
...
- [ ] 1. One-time password
- [x] **2. Challenge-response method, with a symmetric key system.** ✅
- [ ] 3. Fixed password
...
- [x] **4. by applying a cryptographic hash function to a shared secret** ✅

> **Explanation:** Mobile networks apply a cryptographic hash/HMAC to a shared secret combined with a random challenge. The shared secret is NEVER transmitted.

### Q3: What is the relation between WiFi, WLAN, VLAN and WPA?

- [x] **1. WPA is the protection method for a WLAN, which uses the WiFi protocol, and can be one of the VLANs in an organization's network.** ✅
...
> **Explanation:** WiFi is the protocol. WLAN is the network type. WPA is the security protocol. VLAN is a separate network segmentation concept.
...
## Page 32: Start Running Programs

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | What is not used as a term for the act of a computer system ... | **2. pass in** |
| Q2 | Login is an exceptional program in the sense that | **2. it need not know whether it is launched ...** |
| Q3 | Regardless of which programs you are running on your compute... | **2. the operating system.** |
| Q4 | Sandboxing is a security mechanism, where | **1. new untrusted software is run in a disco...** |
| Q5 | Single sign-on | **1. can provide access to multiple resources...** |
| Q6 | Single sign-on is characterized by the fact that | **4. security is improved compared to a user ...** |
...
- [x] **2. it need not know whether it is launched by a legitimate user or an attacker.** ✅
...
- [x] **1. new untrusted software is run in a disconnected test system to check it for malicious behaviour.** ✅
...
- [x] **1. can provide access to multiple resources, but it is only valid for a limited session or duration.** ✅
...
- [x] **4. security is improved compared to a user having the same password for multiple services.** ✅

> **Explanation:** With SSO users only need one strong password rather than reusing the same password across multiple services.

---

## Page 33: A Spectrum of Storage Issues

| # | Question Summary | Answer |
|---|-----------------|--------|
| Q1 | A database is an organized collection of data. The organizat... | **2. the data that your (future) employer has...** |
| Q2 | Why do you sometimes need to write zeros and ones over and o... | **4. So that the earlier contents of the file...** |
| Q3 | Password salt is | **4. the random number stored without encrypt...** |
...
- [x] **2. the data that your (future) employer has about its employees.** ✅
- [ ] 3. the photo album on your phone.
- [ ] 4. your medical records, that you collect in a folder of papers.

> **Explanation:** Employee databases contain structured sensitive personal data with complex dependencies. A folder of papers is not a database.
...
- [x] **4. the random number stored without encryption together with each hashed password.** ✅

> **Explanation:** A salt is a random value added before hashing, stored in plaintext alongside the hash. It ensures two users with the same password have different hashes, defeating rainbow table attacks.

---

## Most Tricky Answers to Remember

| Topic | Trap | Correct Answer |
|-------|------|----------------|
| Anonymity | BY whom vs **TO whom** | TO WHOM (who it is hidden from) |
| Availability excluded | Fire, flood, unreadable tape | Excluded = **3** (fire, flood, unauthorized transaction) |
| Security control synonyms | Count 7 terms | **5** (model and policy are NOT synonyms) |
